...
f1 = Frame(root, width=200, height=400, relief=SUNKEN)
f1.pack(side=LEFT)
...
#  f1 按钮区===================  
lbSpace = Label(f1, font=('arial', 16, 'bold'), text="", bd=16).grid(row=0, column=0,rowspan=8)
btnInit = Button(f1, bd=8, fg="black", font=('arial', 10, 'bold' ), text='InitDB', bg='#D3D3D3',width=10,
              command=init_tables).grid(row=1, column=1)
btnResetURL = Button(f1, bd=8, fg="black", font=('arial', 10, 'bold' ), text='RsURL', bg='#D3D3D3',width=10,
              command=UpdateServerlist).grid(row=2, column=1)
                                       
btnPING = Button(f1, bd=8, fg="black", font=('arial', 10, 'bold' ), text='PING', bg='#D3D3D3',width=10,
              command=update).grid(row=3, column=1)
btnBEST = Button(f1, pady=3, bd=8, fg="black", font=('arial', 10, 'bold' ), text='BEST', bg='#D3D3D3', width=10,
              command=showTop10).grid(row=4, column=1)
btnQuit = Button(f1, pady=3, bd=8, fg="black", font=('arial', 10, 'bold' ), text='QUIT', bg='#D3D3D3',width=10, 
